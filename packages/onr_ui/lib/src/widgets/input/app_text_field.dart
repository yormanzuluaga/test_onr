...
class AppTextField extends StatefulWidget {
  const AppTextField({
    ...
    this.isWeb = false,
  }) : assert(!(onHelpIconClick != null && toolTipContent != null), 'Declaring both onHelpIconClick and toolTipContent is not supported.');
...
class _AppTextFieldState extends State<AppTextField> {
  ...
  void didUpdateWidget(covariant AppTextField oldWidget) {
    ...
    if (widget.customErrorText?.isNotEmpty ?? false) {
      _errorText = widget.customErrorText!;
      _hasError = true;
    } else if (oldWidget.customErrorText != null && (widget.customErrorText == null || (widget.customErrorText?.isEmpty ?? false))) {
      _errorText = '';
      _hasError = false;
    }
  }
      ...
      children: [
            ...
            widget.label != null
                ? ConstrainedBox(
                    constraints: BoxConstraints(
                      maxWidth: MediaQuery.of(context).size.width * (widget.onHelpIconClick != null && !kIsWeb ? 0.9 : 1),
                    ),
                    child: RichText(
                      text: TextSpan(
                        text: widget.label,
        ...
        widget.maxLines != null
            ? TextFormField(
                ...
                scrollPadding: widget.scrollPadding != null ? widget.scrollPadding! : const EdgeInsets.all(20.0),
                ...
                cursorColor: _hasError ? AppColors.grey : AppColors.primary,
  ...
  Widget _renderHelpIconfromCallback({
    ...
    return InkWell(
      ...
      onHover: onHover,
      child: Padding(
        padding: isWeb ? const EdgeInsets.only(bottom: AppSpacing.md, left: AppSpacing.sm) : const EdgeInsets.only(left: AppSpacing.sm),
        child: Icon(
          PhosphorIcons.question(),
          color: isHidden ? AppColors.transparent : AppColors.grey,
    ...
    return CompositedTransformTarget(
      ...
      child: OverlayPortal(
        ...
        child: _renderHelpIconfromCallback(
          ...
          onHover: (hasFocus) => hasFocus ? controller.show() : controller.hide(),
          isHidden: isHidden,
          isWeb: isWeb,
        ),
      ),
